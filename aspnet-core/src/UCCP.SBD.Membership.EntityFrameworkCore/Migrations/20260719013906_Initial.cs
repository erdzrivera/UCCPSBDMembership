        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Occupation = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    BaptismDate = table.Column<string>(type: "text", nullable: true),
                    BaptizedBy = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMembershipTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMembers_LastName",
                table: "AppMembers",
                column: "LastName");

            migrationBuilder.CreateIndex(
                name: "IX_AppMembershipTypes_Name",
                table: "AppMembershipTypes",
                column: "Name");
